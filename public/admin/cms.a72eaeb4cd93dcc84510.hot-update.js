...
var Pricing = function Pricing(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("section", {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Col"], {
      ...
      className: "" + (price.recommended ? 'text-white' : 'bg-primary'),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 19
      },
      ...
      className: "display-4 " + (price.recommended ? 'text-white' : 'bg-primary'),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 20
      },
...
//# sourceMappingURL=cms.a72eaeb4cd93dcc84510.hot-update.js.map